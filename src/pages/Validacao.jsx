...
const norm = t => ' '.join((t || '').split()).toLowerCase()
...
function calcValorTiny(products) {
  return products.reduce((total, item) => {
    ...
    const fator = nome.trim().toLowerCase().replace(/\s+/g,' ') === EXCECAO_50 ? 0.5 : 0.1
...
cd /home/ubuntu/themens-dashboard
git add -A
git commit -m "Validacao: coluna Valor Tiny no lugar de Status"
git push
q
cat > /home/ubuntu/themens-dashboard/src/pages/Validacao.jsx << 'ENDOFFILE'
import { useState } from 'react'
import { supabase } from '../supabase'
